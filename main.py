...
TRACK = pygame.transform.scale(pygame.image.load(os.path.join("Assets", "Track2.png")), (SCREEN_WIDTH, SCREEN_HEIGHT))
...
def eval_genomes(genomes, config):
    ...
    def statistics():
        ...
        text_3 = FONT.render(f'Max Simulation Score:  {lastBest:.1f}', True, (222, 155, 64))
